            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        ...
                        {{-- <img src="{{ asset('/cork/html/src/assets/img/logo2.svg') }}" class="navbar-logo" alt="logo"> --}}
                    </a>
                </li>
                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    ...
                                    <img src="{{ asset('/cork/html/src/assets/img/profile-16.jpg') }}" class="img-fluid me-2" alt="avatar">
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    ...
                                    <img src="{{ asset('/cork/html/src/assets/img/profile-15.jpg') }}" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                ...
                                <img alt="avatar" src="{{ asset('/cork/html/src/assets/img/profile-30.png') }}" class="rounded-circle">
                            </div>
                        </div>
                    </a>
