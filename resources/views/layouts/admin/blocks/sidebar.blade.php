            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="layouts"
                            data-bs-parent="#accordionExample">
                            <li>
                    ...
                    <li class="menu">
                        <a target="_blank" href="https://designreset.com/cork/documentation/index.html"
                    ...
                    <li class="menu">
                        <a target="_blank" href="https://designreset.com/cork/documentation/changelog.html"
                            aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
